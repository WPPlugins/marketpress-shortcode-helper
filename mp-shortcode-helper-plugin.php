...
if(!defined("MP_CURRENT_PAGE"))
	...
	function mp_shortcode($context) {
        if(!$is_post_edit_page)
			return $context.="<a href='#TB_inline?width=480&inlineId=mp_shortcodes' class='thickbox' id='add_mp_shortcode' title='" . __("Add MarketPress Shortcode", 'mp_shortcode') . "'><img src='".plugin_dir_url(__FILE__)."/images/mp-button.png'></a>";
    }
